...
const ShopCategory = (props) => {
  ...
  return (
    <div className='container mx-auto lg:px-20 md:px-10'>
      <img className='lg:py-10 md:py-5' src={props.banner} alt="banner" />
      <div className='flex justify-between items-center'>
        <p className='font-normal'>
          <span className='font-semibold'>Showing 1-12</span> out of 36 Products
        </p>
        <div className='md:px-3 md:py-1 md:text-sm flex justify-between items-center gap-3 border border-black lg:px-5 lg:py-2 lg:text-xl rounded-full cursor-pointer'>
